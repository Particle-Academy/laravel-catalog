...
<div wire:poll.15s="$refresh" class="catalog-admin-products">
                            ...
                            <td>
                                ...
                                <div class="mt-1 catalog-text-xs catalog-text-muted">
                                    @if($product->isOutOfSync())
                                        <span class="text-amber-600">Out of sync with Stripe</span>
    ...
    {{-- Product Modal --}}
    @if($showProductModal)
        <div class="catalog-modal-overlay" wire:click="closeProductModal">
            <div class="catalog-modal-flyout" wire:click.stop>
                <div class="catalog-modal-header">
                    ...
                    <button type="button" class="catalog-btn catalog-btn-ghost catalog-btn-sm" wire:click="closeProductModal" aria-label="Close">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="catalog-modal-body">
                    ...
                    @if($productTab === 'details')
                        <div class="catalog-space-y-6">
                            <div class="catalog-field">
                                <label class="catalog-label">Name <span class="text-red-500">*</span></label>
                                <input type="text" 
                                       class="catalog-input" 
                    ...
                    @if($productTab === 'pricing')
                        <div class="catalog-space-y-4">
                            ...
                            @forelse($productPrices as $index => $price)
                                <div class="catalog-flex catalog-items-center catalog-justify-between rounded-lg border border-zinc-200 bg-white px-4 py-3 catalog-text-sm dark:border-white/10 dark:bg-zinc-900">
                            ...
                            @empty
                                <div class="rounded-lg border border-dashed border-zinc-300 dark:border-white/20 p-6 catalog-text-center">
                ...
                <div class="catalog-modal-footer">
                    <div class="catalog-flex catalog-items-center catalog-justify-between catalog-gap-2">
                        <div>
                            @if($editingProductId)
                                <button type="button" 
                                        class="catalog-btn catalog-btn-ghost catalog-text-red-600 hover:catalog-text-red-700" 
